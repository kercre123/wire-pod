...
var texts = map[string][]string{
	...
	STR_VOLUME_LOW:                     {"low", "basso", "minimo", "bajo", "bas", "niedrig", "niski", "低", "düşük", "низкий", "laag", "на мінімум", "thấp"},
	...
	STR_VOLUME_LOUD:                    {"loud", "massimo", "rumoroso", "fuerte", "fort", "laut", "głośny", "高", "gürültülü", "громкий", "luidruchtig", "гучний", "to"},
	...
	STR_ONE:							{"one","one","uno","un","one","one","one","one","one","one","one","one"},
	STR_TWO:							{"due","two","two","deux","two","two","two","two","two","two","two","two"},
	STR_THREE:							{"tre","three","three","trois","three","three","three","three","three","three","three","three"},
	STR_FOUR:							{"quattro","four","four","quatre","four","four","four","four","four","four","four","four"},
	STR_FIVE:							{"cinque","five","five","cinq","five","five","five","five","five","five","five","five"},
	STR_SIX:							{"sei","six","six","six","six","six","six","six","six","six","six","six"},
	STR_SEVEN:							{"sette","seven","seven","sept","seven","seven","seven","seven","seven","seven","seven","seven"},
	STR_EIGHT:							{"otto","eight","eight","huit","eight","eight","eight","eight","eight","eight","eight","eight"},
	STR_NINE:							{"nove","nine","nine","neuf","nine","nine","nine","nine","nine","nine","nine","nine"},
	STR_TEN:							{"dieci","ten","ten","dix","ten","ten","ten","ten","ten","ten","ten","ten"},
	STR_ELEVEN:							{"undici","eleven","eleven","onze","eleven","eleven","eleven","eleven","eleven","eleven","eleven","eleven"},
	STR_TWELVE:							{"dodici","twelve","twelve","douze","twelve","twelve","twelve","twelve","twelve","twelve","twelve","twelve"},
	STR_THIRTEEN:						{"tredici","thirteen","thirteen","treize","thirteen","thirteen","thirteen","thirteen","thirteen","thirteen","thirteen","thirteen"},
	STR_FOURTEEN:						{"quattordici","fourteen","fourteen","quatorze","fourteen","fourteen","fourteen","fourteen","fourteen","fourteen","fourteen","fourteen"},
	STR_FIFTEEN:						{"quindici","fifteen","fifteen","quinze","fifteen","fifteen","fifteen","fifteen","fifteen","fifteen","fifteen","fifteen"},
	STR_SIXTEEN:						{"sedici","sixteen","sixteen","seize","sixteen","sixteen","sixteen","sixteen","sixteen","sixteen","sixteen","sixteen"},
	STR_SEVENTEEN:						{"diciassette","seventeen","seventeen","dix-sept","seventeen","seventeen","seventeen","seventeen","seventeen","seventeen","seventeen","seventeen"},
	STR_EIGHTEEN:						{"diciotto","eighteen","eighteen","dix-huit","eighteen","eighteen","eighteen","eighteen","eighteen","eighteen","eighteen","eighteen"},
	STR_NINETEEN:						{"diciannove","nineteen","nineteen","dix-neuf","nineteen","nineteen","nineteen","nineteen","nineteen","nineteen","nineteen","nineteen"},
	STR_TWENTY:							{"venti","twenty","twenty","vingt","twenty","twenty","twenty","twenty","twenty","twenty","twenty","twenty"},
	STR_THIRTY:							{"trenta","thirty","thirty","trente","thirty","thirty","thirty","thirty","thirty","thirty","thirty","thirty"},
	STR_FOURTY:							{"quaranta","fourty","fourty","quarante","fourty","fourty","fourty","fourty","fourty","fourty","fourty","fourty"},
	STR_FIFTY:							{"cinquanta","fifty","fifty","cinquante","fifty","fifty","fifty","fifty","fifty","fifty","fifty","fifty"},
	STR_SIXTY:							{"sessanta","sixty","sixty","soixante","sixty","sixty","sixty","sixty","sixty","sixty","sixty","sixty"},
	STR_SEVENTY:						{"settanta","seventy","seventy","soixante-dix","seventy","seventy","seventy","seventy","seventy","seventy","seventy","seventy"},
	STR_EIGHTY:							{"ottanta","eighty","eighty","quatre-vingt","eighty","eighty","eighty","eighty","eighty","eighty","eighty","eighty"},
	STR_NINETY:							{"novanta","ninety","ninety","quatre vingt dix","ninety","ninety","ninety","ninety","ninety","ninety","ninety","ninety"},
	STR_ONE_HUNDRED:					{"cento","one hundred","one hundred","cent","one hundred","one hundred","one hundred","one hundred","one hundred","one hundred","one hundred","one hundred"},
	STR_ONE_HOUR:						{"un'ora","un ora","one hour","une heure","one hour","one hour","one hour","one hour","one hour","one hour","one hour","one hour"},
	STR_ONE_HOUR_ALT:					{"an hour","an hour","an hour","une heure","an hour","an hour","an hour","an hour","an hour","an hour","an hour","an hour"},
	STR_HOUR:							{"ora","ore","hour","heure","hour","hour","hour","hour","hour","hour","hour","hour"},
	STR_MINUTE:							{"minuto","minuti","minute","minute","minute","minute","minute","minute","minute","minute","minute","minute"},
	STR_SECOND:							{"secondo","secondi","second","seconde","second","second","second","second","second","second","second","second"},
}
