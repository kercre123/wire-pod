...
var texts = map[string][]string{
	...
	STR_VOLUME_LOW:                     {"low", "minimo", "bajo", "bas", "niedrig", "niski", "低", "düşük", "низкий", "laag", "на мінімум", "thấp"},
	STR_VOLUME_QUIET:                   {"quiet", "basso", "tranquilo", "silencieux", "ruhig", "cichy", "安静", "sessiz", "тихо", "rustig", "тихо", "yên tĩnh"},
	...
	STR_VOLUME_LOUD:                    {"loud", "massimo", "fuerte", "fort", "laut", "głośny", "高", "gürültülü", "громкий", "luidruchtig", "гучний", "to"},
	...
	STR_ONE:							{"one","uno","one","un","one","one","one","one","one","one","one","one"},
	STR_TWO:							{"two","due","two","deux","two","two","two","two","two","two","two","two"},
	STR_THREE:							{"three","tre","three","trois","three","three","three","three","three","three","three","three"},
	STR_FOUR:							{"four","quattro","four","quatre","four","four","four","four","four","four","four","four"},
	STR_FIVE:							{"five","cinque","five","cinq","five","five","five","five","five","five","five","five"},
	STR_SIX:							{"six","sei","six","six","six","six","six","six","six","six","six","six"},
	STR_SEVEN:							{"seven","sette","seven","sept","seven","seven","seven","seven","seven","seven","seven","seven"},
	STR_EIGHT:							{"eight","otto","eight","huit","eight","eight","eight","eight","eight","eight","eight","eight"},
	STR_NINE:							{"nine","nove","nine","neuf","nine","nine","nine","nine","nine","nine","nine","nine"},
	STR_TEN:							{"ten","dieci","ten","dix","ten","ten","ten","ten","ten","ten","ten","ten"},
	STR_ELEVEN:							{"eleven","undici","eleven","onze","eleven","eleven","eleven","eleven","eleven","eleven","eleven","eleven"},
	STR_TWELVE:							{"twelve","dodici","twelve","douze","twelve","twelve","twelve","twelve","twelve","twelve","twelve","twelve"},
	STR_THIRTEEN:						{"thirteen","tredici","thirteen","treize","thirteen","thirteen","thirteen","thirteen","thirteen","thirteen","thirteen","thirteen"},
	STR_FOURTEEN:						{"fourteen","quattordici","fourteen","quatorze","fourteen","fourteen","fourteen","fourteen","fourteen","fourteen","fourteen","fourteen"},
	STR_FIFTEEN:						{"fifteen","quindici","fifteen","quinze","fifteen","fifteen","fifteen","fifteen","fifteen","fifteen","fifteen","fifteen"},
	STR_SIXTEEN:						{"sixteen","sedici","sixteen","seize","sixteen","sixteen","sixteen","sixteen","sixteen","sixteen","sixteen","sixteen"},
	STR_SEVENTEEN:						{"seventeen","diciassette","seventeen","dix-sept","seventeen","seventeen","seventeen","seventeen","seventeen","seventeen","seventeen","seventeen"},
	STR_EIGHTEEN:						{"eighteen","diciotto","eighteen","dix-huit","eighteen","eighteen","eighteen","eighteen","eighteen","eighteen","eighteen","eighteen"},
	STR_NINETEEN:						{"nineteen","diciannove","nineteen","dix-neuf","nineteen","nineteen","nineteen","nineteen","nineteen","nineteen","nineteen","nineteen"},
	STR_TWENTY:							{"twenty","venti","twenty","vingt","twenty","twenty","twenty","twenty","twenty","twenty","twenty","twenty"},
	STR_THIRTY:							{"thirty","trenta","thirty","trente","thirty","thirty","thirty","thirty","thirty","thirty","thirty","thirty"},
	STR_FOURTY:							{"fourty","quaranta","fourty","quarante","fourty","fourty","fourty","fourty","fourty","fourty","fourty","fourty"},
	STR_FIFTY:							{"fifty","cinquanta","fifty","cinquante","fifty","fifty","fifty","fifty","fifty","fifty","fifty","fifty"},
	STR_SIXTY:							{"sixty","sessanta","sixty","soixante","sixty","sixty","sixty","sixty","sixty","sixty","sixty","sixty"},
	STR_SEVENTY:						{"seventy","settantta","seventy","soixante-dix","seventy","seventy","seventy","seventy","seventy","seventy","seventy","seventy"},
	STR_EIGHTY:							{"eighty","ottanta","eighty","quatre-vingt","eighty","eighty","eighty","eighty","eighty","eighty","eighty","eighty"},
	STR_NINETY:							{"ninety","novanta","ninety","quatre vingt dix","ninety","ninety","ninety","ninety","ninety","ninety","ninety","ninety"},
	STR_ONE_HUNDRED:					{"one hundred","cento","one hundred","cent","one hundred","one hundred","one hundred","one hundred","one hundred","one hundred","one hundred","one hundred"},
	STR_ONE_HOUR:						{"one hour","un'ora","one hour","une heure","one hour","one hour","one hour","one hour","one hour","one hour","one hour","one hour"},
	STR_ONE_HOUR_ALT:					{"an hour","un ora","an hour","une heure","an hour","an hour","an hour","an hour","an hour","an hour","an hour","an hour"},
	STR_HOUR:							{"hour","ore","hour","heure","hour","hour","hour","hour","hour","hour","hour","hour"},
	STR_MINUTE:							{"minute","minuti","minute","minute","minute","minute","minute","minute","minute","minute","minute","minute"},
	STR_SECOND:							{"second","secondi","second","seconde","second","second","second","second","second","second","second","second"},
}
